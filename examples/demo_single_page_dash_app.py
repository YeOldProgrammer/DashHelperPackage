...
"""
import dash
from dash import html, Input, Output, State, dcc, callback, ctx
...
from dash_helper import dash_callback_helper_register
from callback_logic import DASH_CONTROL_BUTTON1_INPUT_ID, \
...
#               Input(DASH_CONTROL_BUTTON2_INPUT_ID, DASH_CONTROL_BUTTON_INPUT_PROP, allow_optional=True),
#             ],
#             prevent_initial_call=True,
#             api_endpoint='/api/calculate'
#           )
# def traditional_callback(btn1_nclicks, btn2_nclicks):
#     output = btn1_nclicks + 1
#     if ctx:
#         return output,
#     return jsonify(output,)


dash_callback_helper_register(Output(DASH_CONTROL_DIV_OUTPUT_ID1, DASH_CONTROL_DIV_OUTPUT_PROP, allow_duplicate=True),
                              Input(DASH_CONTROL_BUTTON1_INPUT_ID, DASH_CONTROL_BUTTON_INPUT_PROP),
